...
DEFAULT_A_GCJ = [118.746956, 32.232945]  # 默认起点
DEFAULT_B_GCJ = [118.751589, 32.235204]  # 默认终点
...
def main():
    ...
    st.sidebar.info(f"🏫 南京科技职业学院\n🚧 障碍物: {obs_count}\n📌 直线路径: {'🚫 被阻挡' if straight_blocked else '✅ 畅通'}")
    ...
    # ==================== 飞行监控页面 ====================
        ...
        if current_time - st.session_state.last_hb_time >= 0.3:
